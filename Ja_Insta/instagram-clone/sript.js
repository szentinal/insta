...
function generatePosts() {
    for (let i = 0; i < names.length; i++) {
        ...
        postContainer.innerHTML += createPostContent(i, profileImage, name, location, image, likeAmount, comment);
    }

}

// Function to create return content for post
function createPostContent(i, profileImage, name, location, image, likeAmount, comment) {
    return /* html */`
        <div class="post">
            ...
            <div class="commentArea">
                ...
                <input type="text" placeholder="Type your comment" id="commentInput">
